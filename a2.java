...
public class a2 extends AppCompatActivity {
    ...
    private BluetoothAdapter mBluetoothAdapter = Button.MBTA;
    private BluetoothAdapter myBTA = Button.MBTA;
    private BluetoothChatService mChatService = Button.MCS;
    private BluetoothChatService myCS = Button.MCS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --------------------------------------------------------------------------------------------------
//        Gson gson = new Gson();
//        myBTA = getIntent().getStringExtra(Button.BT_ADAPTER);
//        myBTA = gson.fromJson(getIntent().getStringExtra(Button.BT_ADAPTER), BluetoothAdapter.class);
//        myCS = gson.fromJson(getIntent().getStringExtra(Button.BT_CHATSERV), BluetoothChatService.class);
        // ------------------------------------------------ USE gson TO CONVERT OBJECT TO SEND/RECEIVE
...
//        mBluetoothAdapter = Button.MBTA;
//        mChatService = Button.MCS;
//        System.out.print(mBluetoothAdapter);
//        System.out.print(mBluetoothAdapter==null);
//        System.out.print(mChatService);
//        Toast.makeText(getApplicationContext(), String.valueOf(mChatService), Toast.LENGTH_LONG).show();
        Toast.makeText(getApplicationContext(), String.valueOf(mChatService.getState()), Toast.LENGTH_LONG).show();
//        Toast.makeText(getApplicationContext(), String.valueOf(mBluetoothAdapter), Toast.LENGTH_LONG).show();
...
//        mChatService.connect(device, port_number,true);
        ...
        // -----------------------------------------------------------------
        // -----------------------------------------------------------------
        final Intent intent = new Intent(this, a3.class);  //TK TK TK
//        final Intent intent2 = new Intent(this, a3.class);  //TK TK TK
        // -----------------------------------------------------------------
        // -----------------------------------------------------------------
        // -----------------------------------------------------------------
...
//                    intent.putExtra(Button.BT_CHATSERV, (Parcelable) mChatService);
//                    intent.putExtra(Button.BT_ADAPTER, String.valueOf(mBluetoothAdapter));
